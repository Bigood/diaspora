    ...
    module Entities
      ...
      def self.profile(profile)
        DiasporaFederation::Entities::Profile.new(
          ...
          carto_user_type:  profile.carto_user_type,
          carto_technics:   profile.carto_technics,
          carto_activites:  profile.carto_activites,
          carto_methods:    profile.carto_methods,
